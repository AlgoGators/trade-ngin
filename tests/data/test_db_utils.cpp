...
std::shared_ptr<arrow::Table> create_test_market_data() {
    ...
    std::shared_ptr<arrow::Array> timestamp_array, symbol_array, open_array, high_array, low_array,
    ...
    return arrow::Table::Make(schema, {timestamp_array, symbol_array, open_array, high_array,
