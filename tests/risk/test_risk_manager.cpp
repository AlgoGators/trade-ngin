// RiskManager unit tests, including folded-in internal-branch coverage
// (calculate_99th_percentile, calculate_weights, update_config paths).
//
...
// ===== folded in from tests/risk/test_risk_manager_extended.cpp =====
