...
//
//     // Process valid data first to build history - in smaller chunks to identify
//     // any specific issues
...
// // Test state transitions: INITIALIZED -> RUNNING -> PAUSED -> RUNNING ->
// // STOPPED
...
// // Test position buffering so that small price movements do not trigger
// // significant changes
...
// // Test that the strategy obeys risk limits when configured with tight
// // constraints
...
// // Test multiple instruments are handled correctly and total exposure is within
// // limits
