 ...
 *
 * Note: The current equity strategy implementation relies on total-return
 * adjusted prices (computed per-bar by the loader from div_cash/split_factor)
 * to account for dividends and splits. This struct
