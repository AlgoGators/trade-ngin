...
// Config structs (NormalizationConfig, PCAConfig, ADFTestConfig, KPSSTestConfig,
// JohansenTestConfig, EngleGrangerConfig, GARCHConfig, KalmanFilterConfig,
// HMMConfig, TestResult, CointegrationResult, etc.) are defined in
// statistics_common.hpp — included above.
 ...
 * Skipped if the standalone base/state_estimator.hpp was already included.
 */
#ifndef TRADE_NGIN_STATISTICS_BASE_STATE_ESTIMATOR_HPP
...
#endif // TRADE_NGIN_STATISTICS_BASE_STATE_ESTIMATOR_HPP
 ...
 * Skipped if the standalone state_estimation/hmm.hpp was already included.
 */
#ifndef TRADE_NGIN_STATISTICS_STATE_ESTIMATION_HMM_HPP
...
#endif // TRADE_NGIN_STATISTICS_STATE_ESTIMATION_HMM_HPP
