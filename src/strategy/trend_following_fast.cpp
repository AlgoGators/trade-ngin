...
TrendFollowingFastStrategy::TrendFollowingFastStrategy(std::string id, StrategyConfig config,
    ...
    metadata_.description =
        "Multi-timeframe fast trend following using EMA crossovers with shorter windows";
}
...
double TrendFollowingFastStrategy::apply_position_buffer(const std::string& symbol,
...
std::unordered_map<int, double> TrendFollowingFastStrategy::get_ema_values(
